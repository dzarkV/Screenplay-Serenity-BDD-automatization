...
public class DemoQaDatesPickerPage extends PageObject {
    ...
    //Date and time input
    public static final Target D_T_INPUT = Target.the("Date and time picker input")
            .locatedBy("#dateAndTimePickerInput");

    public static final Target D_T_MONTH_VIEW = Target.the("View dropdown of month on date and time")
            .locatedBy(".react-datepicker__month-read-view");

    public static final Target D_T_MONTH_SELECT = Target.the("Select month on date and time")
            .locatedBy(
                    "//div[@class='react-datepicker__month-dropdown']/child::div[text()='{0}']");

    public static final Target D_T_YEAR_VIEW = Target.the("View dropdown of year on date and time")
            .locatedBy(".react-datepicker__year-read-view");

    public static final Target D_T_YEAR_SELECT = Target.the("Select year on date and time")
            .locatedBy(
                    "//div[@class='react-datepicker__year-dropdown']/child::div[text()='{0}']");

    public static final Target D_T_DAY_SELECT = Target.the("Select day on date and time")
            .locatedBy(
                    "(//div[@role='listbox']/child::div/child::div[text()='{0}'])[1]");

    public static final Target D_T_TIME_SELECT = Target.the("Select time on date and time")
            .locatedBy(
